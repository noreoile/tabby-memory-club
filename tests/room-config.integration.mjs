...
await call('reaction',w.token,{emoji:'🎉',reactionId:crypto.randomUUID()});assert.equal(room.reactions.at(-1).emoji,'🎉');
await new Promise(r=>setTimeout(r,750));await call('reaction',w.token,{emoji:'not-allowed',reactionId:crypto.randomUUID()},400);
